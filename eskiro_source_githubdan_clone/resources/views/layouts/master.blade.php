...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="{{ route('home') }}" class="logo"> <img src="{{ URL::to('assets/img/logo.png') }}"
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <i class="fa fa-comment-o"></i>
                        <span class="badge badge-pill">8</span> </a>
                    <div class="dropdown-menu notifications">
                        <div class="topnav-dropdown-header"> <span class="notification-title">Messages</span> <a
                                ...
                                <li class="notification-message">
                                    <a href="chat.html">
                                        <div class="list-item">
                                            ...
                                            <div class="list-body"> <span class="message-author">Richard Miles </span>
                                                <span class="message-time">12:28 AM</span>
                                                <div class="clearfix"></div> <span class="message-content">Lorem ipsum
                                ...
                                <li class="notification-message">
                                    <a href="chat.html">
                                        <div class="list-item">
                                            ...
                                            <div class="list-body"> <span class="message-author">John Doe</span> <span
                                ...
                                <li class="notification-message">
                                    <a href="chat.html">
                                        <div class="list-item">
                                            ...
                                            <div class="list-body"> <span class="message-author"> Tarah Shropshire
                                                </span> <span class="message-time">5 Mar</span>
                                                <div class="clearfix"></div> <span class="message-content">Lorem ipsum
                                                    dolor sit amet, consectetur adipiscing</span>
                                            </div>
                                        </div>
                                ...
                                <li class="notification-message">
                                    <a href="chat.html">
                                        <div class="list-item">
                                            ...
                                            <div class="list-body"> <span class="message-author">Mike Litorus</span>
                                ...
                                <li class="notification-message">
                                    <a href="chat.html">
                                        <div class="list-item">
                                            ...
                                            <div class="list-body"> <span class="message-author"> Catherine Manseau
                                                </span> <span class="message-time">27 Feb</span>
                                                <div class="clearfix"></div> <span class="message-content">Lorem ipsum
                                                    dolor sit amet, consectetur adipiscing</span>
                                            </div>
                                        </div>
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('profile_user') }}">Mening profilim</a>
                        <a class="dropdown-item" href="{{ route('company/settings/page') }}">Sozlamlar</a>
    ...
    @include('dashboard.partials.javascripts')
