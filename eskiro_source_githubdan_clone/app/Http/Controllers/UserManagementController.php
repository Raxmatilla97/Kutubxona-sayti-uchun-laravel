...
class UserManagementController extends Controller
{
    public function index()
    {
        if (Auth::user()->role_name=='Admin')
        {
            ...
            return view('dashboard.specal-pages.usermanagement.user_control',compact('result','role_name','position','department','status_user'));
        }
        else
        {
    ...
    public function searchUser(Request $request)
    {
        if (Auth::user()->role_name=='Admin')
        {
            ...
            return view('dashboard.specal-pages.usermanagement.user_control',compact('users','role_name','position','department','status_user','result'));
        }
        else
        {
            return redirect()->route('home');
    ...
    public function activityLog()
    {
        ...
        return view('dashboard.specal-pages.usermanagement.user_activity_log',compact('activityLog'));
    }
    // activity log
    public function activityLogInLogOut()
    {
        $activityLog = DB::table('activity_logs')->get();
        return view('dashboard.specal-pages.usermanagement.activity_log',compact('activityLog'));
    }
    ...
    public function profile()
    {
        ...
        if(empty($employees))
        {
            ...
            return view('dashboard.specal-pages.usermanagement.profile_user',compact('information','user'));
